...
public:
    ...
    stringx(_derive_type &&rvalue) noexcept : _basic_type(std::move(rvalue))
    {
    }

    stringx &operator=(_derive_type &&rvalue)
    {
    ...
    stringx &operator=(const _Elem *_Ptr)
    {
        //this->assign(_Ptr);
    ...
    stringx &operator=(const _basic_type &basic_str)
    {
    ...
    stringx &operator=(const _derive_type &strx)
    {
...
private:
    std::basic_ostringstream<_Elem> m_sstream;
public:
    template<typename HEAD, typename ...TAIL>
    void format_multitype(HEAD&& first, TAIL&&... args)
    {
        m_sstream << first;
        format_multitype(std::forward<TAIL>(args)...);
    }
    ...
    {
        m_sstream << value;
        _basic_type::assign(m_sstream.str());
        m_sstream.clear();
        m_sstream.str(_basic_type());
    }
